...
- **Read:** search, filter, save papers, inspect run history, and export a Markdown digest or BibTeX from a local dashboard with English and Chinese interface controls.
